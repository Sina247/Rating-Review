...
submitBtn.addEventListener("click", () => {
  if (Number(rateValue.textContent) === 0) {
    ...
    message.textContent = "If you're seeing this page, it means you've been trying to play smart lately and I commend you for that. However, you need to pick a rating first.";
  }
